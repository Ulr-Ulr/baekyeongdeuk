    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
          ...
          <!-- form start -->
          <form name="update_form" action="/admin/bbs_type/bbs_type_write" method="post">
              ...
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  <div class="form-group">
                	...
                	<input type="text" value="" class="form-control" name="board_type" id="board_type" placeholder="게시판타입을 영문으로 입력해주세요." required>
                  </div>
                  <div class="form-group">
