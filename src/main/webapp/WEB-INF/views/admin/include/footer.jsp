...
$(document).ready(function(){
	...
	$(".nav-treeview li a").each(function(){
		...
		if( $(this).attr('href').indexOf(current_2) !== -1 ) {
			...
			$(this).removeClass("active");//선택하지 않는 메뉴의 배경색상을 제거하는 처리.
		
		}
			
	});//each함수로 a태그 2개를 찾는 명령.
});
//$(this)현재함수의구현대상 본인을 가르킨다
//2개의 값을 비교1:- a태그의값 /admin.member_list, /admin/board_list
//2개의 값을 비교2:- 비교대상 current_2(현재 부라우저의 URL값중 제일 마지막 값 )
</script>
</body>
</html>
<!-- 관리자단 푸터 끝 -->